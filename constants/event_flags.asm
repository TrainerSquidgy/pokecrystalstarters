...
; Kanto hidden items
	...
	const EVENT_RECEIVED_SCYTHE
	const EVENT_RECEIVED_AIR_BALLOON
	const EVENT_RECEIVED_RAFT
	const EVENT_RECEIVED_BURLY_MAN
	const EVENT_RECEIVED_LANTERN
	const EVENT_RECEIVED_BATH_PLUG
	const EVENT_RECEIVED_LADDER
	const EVENT_RECEIVED_FART_JAR
	const EVENT_RECEIVED_HONEY_JAR
	const EVENT_RECEIVED_TREE_SHAKER
