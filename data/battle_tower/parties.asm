...
; BattleTowerMons group 1
	...
	db MISDREAVUS
	db FOCUS_BAND
	db PERISH_SONG, MEAN_LOOK, CURSE, SHADOW_BALL
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	db HITMONLEE
	db FOCUS_BAND
	db REVERSAL, ENDURE, BODY_SLAM, JUMP_KICK
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 8
	...
	db MOLTRES
	db CHARCOAL
	db FLAMETHROWER, WING_ATTACK, STEEL_WING, HYPER_BEAM
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 9
	...
	db ESPEON
	db GOLD_BERRY
	db PSYCHIC_M, SHADOW_BALL, SUNNY_DAY, RECOVER
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
