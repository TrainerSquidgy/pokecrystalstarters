...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move HEAL_BLOCK,   EFFECT_HEAL_BLOCK,          0, PSYCHIC_TYPE, 100, 15,   0
	...
	move WONDER_ROOM,  EFFECT_WONDER_ROOM,         0, PSYCHIC_TYPE, 100, 10,   0
	...
	move SNATCH,       EFFECT_SNATCH,              0, DARK,         100, 10,   0
	move PSYSHOCK,     EFFECT_PSYSHOCK,           80, PSYCHIC_TYPE, 100, 10,   0
	move ENDEAVOR,     EFFECT_ENDEAVOR,            0, NORMAL,       100,  5,   0
