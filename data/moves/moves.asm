...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move HEX,          EFFECT_HEX,                65, GHOST,        100, 10,   0
	...
	move EXTRASENSORY, EFFECT_FLINCH_HIT,         80, PSYCHIC_TYPE,  80, 20,  10
	...
	move BABYDOLLEYES, EFFECT_ATK_DOWN_PRIORITY,   0, FAIRY_S,      100, 30,   0
