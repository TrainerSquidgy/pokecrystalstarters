...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move SMELLINGSALT, EFFECT_SMELLINGSALT,       60, NORMAL,       100, 10,   0
	...
	move ARM_THRUST,   EFFECT_MULTI_HIT,          15, FIGHTING,     100, 20,   0
	move FAKE_OUT,     EFFECT_FAKE_OUT,           40, NORMAL,       100, 10, 100
	move KNOCK_OFF,    EFFECT_KNOCK_OFF,          20, DARK,         100, 20,   0 
