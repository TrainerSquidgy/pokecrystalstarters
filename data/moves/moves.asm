...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move RAGING_BULL,  EFFECT_RAGING_BULL,        90, FIGHTING,     100, 10,   0
	...
	move WORK_UP,	   EFFECT_WORK_UP,             0, NORMAL,       100, 30,   0
	move ASSURANCE,	   EFFECT_ASSURANCE,          60, DARK,         100, 10,   0
	move ZEN_HEADBUTT, EFFECT_FLINCH_HIT,         80, NORMAL,        90, 15,  20
