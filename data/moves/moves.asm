...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move FLAME_BURST,  EFFECT_NORMAL_HIT,         70, FIRE,         100, 15,   0
	...
	move TRICK,        EFFECT_TRICK,               0, PSYCHIC_TYPE, 100, 10,   0
	...
	move MIND_BLOWN,   EFFECT_MIND_BLOWN,        150, FIRE,         100,  5,   0
	...
	move ASTONISH,     EFFECT_FLINCH_HIT,         30, GHOST,        100, 25,  30
	move MAGIC_COAT,   EFFECT_MAGIC_COAT,          0, PSYCHIC_TYPE, 100, 15,   0
	move STORED_POWER, EFFECT_STORED_POWER,       20, PSYCHIC_TYPE, 100, 10,   0
