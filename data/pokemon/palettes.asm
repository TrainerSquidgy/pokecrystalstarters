...
INCBIN "gfx/pokemon/chinchou-f/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/chinchou-f/shiny.pal"
INCBIN "gfx/pokemon/lanturn-f/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/lanturn-f/shiny.pal"
