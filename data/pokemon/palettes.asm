...
INCBIN "gfx/pokemon/salandit/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/salandit/shiny.pal"
INCBIN "gfx/pokemon/salazzle/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/salazzle/shiny.pal"
