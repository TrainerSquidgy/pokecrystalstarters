...
INCBIN "gfx/pokemon/growlitheh/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/growlitheh/shiny.pal"
INCBIN "gfx/pokemon/arcanineh/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/arcanineh/shiny.pal"
