...
INCBIN "gfx/pokemon/greavard/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/greavard/shiny.pal"
INCBIN "gfx/pokemon/houndstone/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/houndstone/shiny.pal"
