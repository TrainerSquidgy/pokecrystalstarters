...
INCBIN "gfx/pokemon/elekids/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/elekids/shiny.pal"

INCBIN "gfx/pokemon/electabuzzs/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/electabuzzs/shiny.pal"
