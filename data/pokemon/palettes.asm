...
INCBIN "gfx/pokemon/psyduckh/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/psyduckh/shiny.pal"
INCBIN "gfx/pokemon/golduckh/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/golduckh/shiny.pal"
