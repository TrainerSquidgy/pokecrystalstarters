...
INCBIN "gfx/pokemon/inkay/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/inkay/shiny.pal"
INCBIN "gfx/pokemon/malamar/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/malamar/shiny.pal"
