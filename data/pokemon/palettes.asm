...
INCBIN "gfx/pokemon/voltorbh/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/voltorbh/shiny.pal"
INCBIN "gfx/pokemon/electrodeh/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/electrodeh/shiny.pal"
