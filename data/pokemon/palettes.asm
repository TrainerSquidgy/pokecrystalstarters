...
INCBIN "gfx/pokemon/mankeyp/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/mankeyp/shiny.pal"

INCBIN "gfx/pokemon/primeapep/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/primeapep/shiny.pal"
