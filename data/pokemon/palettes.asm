...
INCBIN "gfx/pokemon/magnemites/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/magnemites/shiny.pal"

INCBIN "gfx/pokemon/magnetons/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/magnetons/shiny.pal"
