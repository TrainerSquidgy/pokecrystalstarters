...
INCBIN "gfx/pokemon/vulpixa/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/vulpixa/shiny.pal"
INCBIN "gfx/pokemon/ninetalesa/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/ninetalesa/shiny.pal"
