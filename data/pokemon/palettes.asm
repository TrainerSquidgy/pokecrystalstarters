...
INCBIN "gfx/pokemon/tandemaus/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/tandemaus/shiny.pal"
INCBIN "gfx/pokemon/maushold/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/maushold/shiny.pal"
