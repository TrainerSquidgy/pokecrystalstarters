...
INCBIN "gfx/pokemon/magbys/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/magbys/shiny.pal"
INCBIN "gfx/pokemon/magmars/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/magmars/shiny.pal"
