...
; entries correspond to Pokémon species, two apiece
	...
	dba_pic HoOhBackpic
	dba_pic LechonkFrontpic
	dba_pic LechonkBackpic
	dba_pic OinkologneMFrontpic
	dba_pic OinkologneMBackpic
	dba_pic OinkologneFFrontpic
	dba_pic OinkologneFBackpic
