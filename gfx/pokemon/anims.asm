...
LechonkAnimation:     INCLUDE "gfx/pokemon/lechonk/anim.asm"
OinkologneMAnimation:     INCLUDE "gfx/pokemon/oinkolognem/anim.asm"
OinkologneFAnimation:     INCLUDE "gfx/pokemon/oinkolognef/anim.asm"
