...
LechonkFrames:     INCLUDE "gfx/pokemon/lechonk/frames.asm"
OinkologneMFrames:     INCLUDE "gfx/pokemon/oinkolognem/frames.asm"
OinkologneFFrames:     INCLUDE "gfx/pokemon/oinkolognef/frames.asm"
