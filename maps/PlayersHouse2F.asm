...
PlayersHouse2F_MapEvents:
	...
	object_event  4,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, PlayersHouse2FShuckleite, EVENT_PLAYERS_HOUSE_2F_SHUCKLEITE
